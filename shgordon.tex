...
\end{align} which leads to an infinite number of Feynman rules for n-point vertex, with n even.
 ...
 \hat M^2=& 16 \pi \hat \mu b^2 + 8 \pi \hat \mu b^4 I(\hat \mu)+ 2 \pi \hat \mu b^6 I(\hat \mu)^2 + O(\hat \mu b^8) \\
 = & \hat m_0 (1 + \frac{1}{2}b^2 I( \hat \mu) + \frac{1}{8} b^4 I(\hat \mu)^2 ) + O(\hat \mu b^8 )
 \end{align} We have the bare mass $\hat m_0 = 16 \pi \hat \mu b^2 $ and the tadpole integral \begin{equation}
 I(\hat \mu) = \int_{BZ} \dfrac{d^2l}{(2 \pi)^2} \dfrac{8 \pi}{\hat{l^2} + 16 \pi \hat \mu b^2
  }
